...
!
 ...
 100   FORMAT( 'Time_index value ', i5, ' must be in the range 1 to 8!' )
    ...
    ! Resolution 0.125x0.15625 use A1dyn archive (xlwang, 06/2024)
...
!
! !DESCRIPTION: Routine to read variables and attributes from a NetCDF
!  met fields file containing 3-hr instantaneous (I1dyn) data.
!\\
!\\
! !INTERFACE:
!
...
!
    ...
    USE Get_Met_Mod
#ifdef BPCH_DIAG
    USE Time_Mod,           ONLY : Set_Ct_I1dyn
#endif
!
! !INPUT PARAMETERS:
!
...
!
 ...
 10 FORMAT( '     - Found all I1dyn     met fields for ', a )
    ...
    ! Initialize State_Met%T to State_Met%TMPU1 and State_Met%SPHU to
    ! State_Met%SPHU1.  After all future MET field reads (flexgrid_read_I1dyn_2)
    ! we will interpolate State_Met%T from the values of State_Met vars
    ! TMPU1 and TMPU2 and State_Met%SPHU from the values of State_Met vars
    ! SPHU1 and SPHU2.
    ! State_Met%T         = State_Met%TMPU1
...
#ifdef BPCH_DIAG
    ! Increment the # of times I1dyn fields have been read
    CALL Set_Ct_I1dyn( INCREMENT=.TRUE. )
#endif
...
!
! !DESCRIPTION: Subroutine COPY\_I1dyn\_FIELDS copies the I-3 fields at the
!  end of a 3-hr timestep.  The I-3 fields at the end of a given 3-hr timestep
!  become the fields at the beginning of the next 3-hr timestep.
!\\
!\\
...
!
      ...
      ! State_Met%TMPU1   = State_Met%TMPU2   ! I1dyn temperature         [K]
